...
public class WorkflowEngineTest extends AbstractSpringTestCase {
	...
	protected void onSetUpInTransaction() throws Exception {
		...
		flowDeployManager.addUserPerformer(user.getId().toString(), fd
				.getFlowNodeBindingByNodeID("dreambike_Wor1_Act2")
				.getNodeBindingID().toString());
		flowDeployManager.addUserPerformer(user.getId().toString(), fd
				.getFlowNodeBindingByNodeID("dreambike_Wor1_Act3")
				.getNodeBindingID().toString());
		flowDeployManager.addUserPerformer(user.getId().toString(), fd
				.getFlowNodeBindingByNodeID("dreambike_Wor1_Act4")
				.getNodeBindingID().toString());
		flowDeployManager.addUserPerformer(user.getId().toString(), fd
				.getFlowNodeBindingByNodeID("dreambike_Wor1_Act6")
				.getNodeBindingID().toString());

		flowDeployManager.addUserPerformer(user.getId().toString(), fd
				.getFlowNodeBindingByNodeID("dreambike_Wor1_Act10")
				.getNodeBindingID().toString());
		flowDeployManager.addUserPerformer(user.getId().toString(), fd
				.getFlowNodeBindingByNodeID("dreambike_Wor1_Act11")
				.getNodeBindingID().toString());
