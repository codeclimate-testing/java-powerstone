...
public class UserPagingController extends PagingController {
	...
	protected ModelAndView doHandleRequest(HttpServletRequest request,
		...
		log.info("recordsBeginNo:" + recordsBeginNo + "|recordsNumberToRead:"
				+ recordsNumberToRead);		
		return new ModelAndView("testPaging", "users", mgr.getUsersByPage(
				recordsBeginNo, recordsNumberToRead));
	}
