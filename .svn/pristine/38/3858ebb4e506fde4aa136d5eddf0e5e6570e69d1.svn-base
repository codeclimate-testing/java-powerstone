...
/**
 * This class parses an XML file and prints the JDOM tree.
 * It can work as a standalone application, but it is also
 * used by other examples of this chapter: CreationSample,
 * DataSample and ElementSample.
 */
public class JDOMPrinter {

  /**
   * Prints a given number of double-spaces followed
   * by a string to the standard output stream.
   */
  ...
  /**
   * This is the implementation of the above print()
   * method. It first prints several node properties:
   * type, name and value. Empty text nodes are
   * ignored. Then it prints the attributes and the
   * children of the given node using recursive calls.
   */
  ...
  /**
   * Parses the document whose path is given in the
   * command line and prints the obtained JDOM tree.
   * If the command line is empty, it uses nodes.xml
   */
