...
public interface FlowMetaConstants {
  ...
  public static final String PREVIEW_VARIABLE = "Preview_Variable"; //任务预览变量
  public static final String FLOW_PREVIEW_VARIABLE = "Flow_Preview_Variable"; //任务预览变量
  ...
  public static final String PERSON_STATE = "personState"; //节点有此扩展属性则不发送其stateID
  public static final String DISTRIBUTABLE = "distributable"; //该任务可以被分配
}
