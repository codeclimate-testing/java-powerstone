...
public class PageModelTest extends TestCase {
	...
	public void testChangePageComputeRecordsBeginNo() {
		...
		pm.setBeEnd(true);
		super.assertEquals("Change1",
				pm.computeRecordsBeginNo(), 50);
		pm.clear();
		
		pm.setBeFirst(true);
		super.assertEquals("Change2",
				pm.computeRecordsBeginNo(), 0);
		pm.clear();
		
		pm.setBeLast(true);
		super.assertEquals("Change3",
				pm.computeRecordsBeginNo(), 0);
		pm.clear();
		
		pm.setBeNext(true);
		super.assertEquals("Change4",
				pm.computeRecordsBeginNo(), 0);
		pm.clear();
		
		pm.setCurrPageNo("3");
		pm.setBeLast(true);
		super.assertEquals("Change5",
				pm.computeRecordsBeginNo(), 10);
		pm.clear();
		
		pm.setBeNext(true);
		super.assertEquals("Change6",
				pm.computeRecordsBeginNo(), 30);
		pm.clear();
	...
	public void testDefaultComputeNewPageNo() {
		super.assertEquals("default NewPageNo", pm.computeNewPageNo(), 1);
		pm.setPageTo("3");
		pm.setTotalRecordsNumber(88);
		pm.setPageSize(20);
		super.assertEquals("compute2", pm.computeNewPageNo(), 3);
		pm.setPageTo("4");
		super.assertEquals("compute3", pm.computeNewPageNo(), 4);
		pm.setPageTo("5");
		super.assertEquals("compute4", pm.computeNewPageNo(), 5);
		pm.setPageTo("6");
		super.assertEquals("compute5", pm.computeNewPageNo(), 5);
	}
	...
	public void testDefaultComputePageCount() {
		...
		pm.setTotalRecordsNumber(88);
		pm.setPageSize(20);
		super.assertEquals("88|20", pm.computePageCount(), 5);
	}
