...
function tijiao(){
  if(document.form1.person.value==""){
    alert('<fmt:message key="task.require_assign_to"/>');
...
<body onload="init();">
<form action="<%=request.getContextPath()%>/assign_task.wl" name="form1">
<tr align="center">
    <td height="25" align="center" class="TD2"  style="border:none; "><fmt:message key="task.persons_to_assign"/></td>
    <td bgcolor="#FFFFFF">
