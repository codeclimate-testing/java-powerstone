...
<table class="tableFrame" cellspacing="1">
  <tr>
     <td class="tdTitle">通知客户订单不能履行</td>
  </tr>
<td class="tdContent">
...
<form method="post" action="<%=request.getContextPath()%>/dreambike/edit_email_refuse.do" name="orderForm">
<table class="tableNoBorderCenter" align="center">
...
<script type="text/javascript">
    document.forms["orderForm"].elements["emailRefuse"].focus();
</script>
