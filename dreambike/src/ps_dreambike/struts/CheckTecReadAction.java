...
public class CheckTecReadAction extends WorkflowDriverReadAction {
  /**
   * doExecute
   *
  ...
  public ActionForward doExecute(ActionMapping actionMapping,
    ...
    httpServletRequest.setAttribute("message","CheckTecReadAction");
    httpServletRequest.setAttribute("action","CheckTecWriteAction");
